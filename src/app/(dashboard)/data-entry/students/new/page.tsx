...
export default function NewStudentPage() {
  ...
  const inp =
    "w-full px-4 py-2.5 rounded-lg bg-bg-input border border-border text-text-primary placeholder:text-text-muted text-sm";
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-slideUp">
      <div className="flex items-center gap-3">
        ...
        <PageHeader
          ...
          description="Register a new student to your school"
          icon={Users}
        />
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input {...register("state")} placeholder="State" className={inp} />
          </div>
        </div>
